...
const InsertionSort = () => {
  ...
  // implement insertionsort working on bars
  ...
  const runInsertionsort = async () => {
    ...
    for (let i = 0; i < animations.length; i++) {
      ...
      if (animation.type === "overwrite") {
        const a = animation.indices[0];
        const b = animation.value;
        newArray[a] = b;
        setArray([...newArray]);
  ...
  const codeLines = [
    <>
      ...
      <span className="text-yellow-400">1</span> to n-1{" "}
      <span className="text-purple-400">do</span>
    </>,
    <>key = arr[i]</>,
    <>j = i - 1</>,
    <>
      <span className="text-purple-400">while</span> j ≥ 0 and arr[j] &gt; key{" "}
      <span className="text-purple-400">do</span>
    </>,
    <>arr[j+1] = arr[j]</>,
    <>j = j - 1</>,
      ...
      <div className="mt-20 w-full flex justify-center place-items-center text-white">
        <section className="w-[80%]">
          ...
          <div className="text-emerald-500">
            <span className="text-gray-400">Home /</span> InsertionSort{" "}
          </div>

          <div className="flex justify-between pt-3 ">
            <span className="font-semibold text-4xl">
              Insertion<span className="text-gray-400">Sort</span>
            </span>
