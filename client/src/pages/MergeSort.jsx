...
const MergeSort = () => {
  ...
  // implement mergesort working on bars
    ...
    for (let i = 0; i < animations.length; i++) {
      ...
      if (animation.type === "sorted") {
        setSortedIndices((prev) => {
          if (!prev.includes(animation.index)) {
...
const codeLines = [
  <>
    ...
    <span className="text-blue-400">mergeSort</span>(arr, l, r)
  </>,
  <>
    <span className="text-purple-400">if</span> l &lt; r
  </>,
  <>mid = (l + r) / 2</>,
  <>
    <span className="text-blue-400">mergeSort</span>(arr, l, mid)
  </>,
  <>
    <span className="text-blue-400">mergeSort</span>(arr, mid + 1, r)
  </>,
  <>
    <span className="text-blue-400">merge</span>(arr, l, mid, r)
  </>,
  <>
      ...
      <div className="mt-20 w-full flex justify-center place-items-center text-white">
        <section className="w-[80%]">
          ...
          <div className="text-emerald-500">
            <span className="text-gray-400">Home /</span> mergeSort{" "}
          </div>

          <div className="flex justify-between pt-3 ">
            <span className="font-semibold text-4xl">
              Merge<span className="text-gray-400">Sort</span>
            </span>
            ...
            <div className="w-[50%] border border-white/10 bg-white/5 rounded-xl p-4">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="rounded-xl border border-yellow-400/30 bg-yellow-400/5 p-4 text-center">
                  ...
                  <p className="text-2xl font-semibold text-yellow-400">O(nlogn)</p>
                </div>
                ...
                <div className="rounded-xl border border-red-400/30 bg-red-400/5 p-4 text-center">
                  ...
                  <p className="text-2xl font-semibold text-red-400">O(nlogn)</p>
                </div>
